defmodule AriakeWeb.AdminUserAuth do
  use AriakeWeb, :verified_routes
  ...
  def log_out_admin_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AriakeWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin_user:
      ...
      defmodule AriakeWeb.PageLive do
        use AriakeWeb, :live_view

        on_mount {AriakeWeb.AdminUserAuth, :mount_current_admin_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AriakeWeb.AdminUserAuth, :ensure_authenticated}] do
